#!/usr/bin/env python3
# ======================================================================
# SYNTHETIC HOUSEHOLD GENERATOR – PHASE 2 (rural)
# Fully corrected version that properly merges:
#   - original X data
#   - autoencoder (concept) data
#   - synthetic X
#   - synthetic autoencoder
# And outputs correct p2x_rural.csv and p2y_rural.csv
# ======================================================================
...
def parse_args():
    ...
    p.add_argument("--x-path",  default="x_rural.csv")
    p.add_argument("--ae-path", default="rural_autoencoder.csv")
    p.add_argument("--y-path",  default="y_rural.csv")
...
def main():
    ...
    print(bold("\n=== SYNTHETIC DATA GENERATOR (PHASE 2, rural) ===\n", color_on))
    ...
    p2x_path = os.path.join(out_inputs, "p2x_rural.csv")
    p2y_path = os.path.join(out_inputs, "p2y_rural.csv")
